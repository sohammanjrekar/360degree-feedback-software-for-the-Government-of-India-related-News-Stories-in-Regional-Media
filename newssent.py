...
def timesofindia():
    ...
    with open("newssent_articles.txt", "w", encoding="utf-8") as file:
            ...
            for ultag in divtag.find_all("ul", {"class": "clearfix"}):
                for litag in ultag.find_all("li"):
                    ...
                    try:
                        ...
                        sentiment_scores = sid.polarity_scores(article_content)
                        sentiment = "Positive" if sentiment_scores["compound"] >= 0 else "Negative"

                        # Write title, content, date, and sentiment to the text file
